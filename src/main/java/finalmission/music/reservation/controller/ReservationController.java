package finalmission.music.reservation.controller;
...
import finalmission.music.reservation.controller.dto.ReservationRequest;
...
public class ReservationController {
    ...
    public ResponseEntity<Void> patchMyReservation(@PathVariable("id") final Long id,
                                                   @LoginMember String name,
                                                   final String newAddress) {
        reservationService.updateMyReservation(id, name, newAddress);
